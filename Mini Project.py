...
def CostofItem():
    ...
    PriceofDrinks =(Item1 * 20) + (Item2 * 20) + (Item3 * 15) + (Item4 * 25) + (Item5 * 100) + (Item6 * 20) + (Item7 * 20) + (Item8 * 20)
...
HotDog = Checkbutton(Food_F,text="HotDog\t\t\t ",variable=var9,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='light green',command=chk_HotDog).grid(row=0,sticky=W)
VegBurger = Checkbutton(Food_F,text="VegBurger",variable=var10,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='light green',command=chk_VegBurger).grid(row=1,sticky=W)
Pasta = Checkbutton(Food_F,text="Pasta ",variable=var11,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='light green',command=chk_Pasta).grid(row=2,sticky=W)
HamBurger = Checkbutton(Food_F,text="Rice Plate ",variable=var12,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='light green',command=chk_HamBurger).grid(row=3,sticky=W)
Sandwich = Checkbutton(Food_F,text="Sandwich ",variable=var13,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='light green',command=chk_Sandwich).grid(row=4,sticky=W)
Fires = Checkbutton(Food_F,text="Fires ",variable=var14,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='light green',command=chk_Fires).grid(row=5,sticky=W)
Spagetti = Checkbutton(Food_F,text="Spagetti ",variable=var15,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='light green',command=chk_Spagetti).grid(row=6,sticky=W)
Fazitas = Checkbutton(Food_F,text="Fazitas ",variable=var16,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='light green',command=chk_Fazitas).grid(row=7,sticky=W)
...
lblCostofDrinks=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Drinks\t',bg='light green',
...
lblCostofFood=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Foods  ',bg='light green',
                fg='black',justify=CENTER)
...
lblServiceCharge=Label(Cost_F,font=('arial',14,'bold'),text='Service Charge',bg='light green',
                fg='black',justify=CENTER)
...
lblTotalCost=Label(Cost_F,font=('arial',14,'bold'),text='\tTotal',bg='light green',bd=7,
                fg='black',justify=CENTER)
...
btnTotal=Button(Buttons_F,padx=16,pady=1,bd=7,fg='red',font=('chiller',16,'bold'),width=4,text='Total',
                        bg='black',command=CostofItem).grid(row=0,column=0)
btnReceipt=Button(Buttons_F,padx=16,pady=1,bd=7,fg='red',font=('chiller',16,'bold'),width=4,text='Receipt',
                        bg='black',command=Receipt).grid(row=0,column=1)
btnReset=Button(Buttons_F,padx=16,pady=1,bd=7,fg='red',font=('chiller',16,'bold'),width=4,text='Reset',
                        bg='black',command=Reset).grid(row=0,column=2)
btnExit=Button(Buttons_F,padx=16,pady=1,bd=7,fg='red',font=('chiller',16,'bold'),width=4,text='Exit',
                        bg='black',command=iExit).grid(row=0,column=3)
